      ...
      <div className="grid lg:grid-cols-5 gap-8">
        <section className="lg:col-span-3">
          ...
          {sent ? (
            <div className="p-8 rounded-2xl bg-emerald-50 border border-emerald-200 text-center">
              <div className="w-14 h-14 rounded-full bg-emerald-500 grid place-items-center mx-auto">
              ...
              <div className="mt-4 font-bold text-emerald-900 text-lg">Message sent.</div>
              <div className="mt-1 text-emerald-800">We'll reply within 4 business hours. Usually sooner.</div>
            </div>
          ) : (
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-5 p-6 sm:p-8 rounded-2xl border border-slate-200 bg-white">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input required type="text" className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition" placeholder="Jane Smith" />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-2">Work email</label>
                  <input required type="email" className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition" placeholder="jane@company.com" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-semibold mb-2">Company (optional)</label>
                <input type="text" className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition" placeholder="Acme Logistics Co." />
              </div>
              <div>
                <label className="block text-sm font-semibold mb-2">What's this about?</label>
                <select className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition bg-white">
              ...
              <div>
                ...
                <input type="text" className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition font-mono" placeholder="EV9876543210" />
              </div>
              <div>
                <label className="block text-sm font-semibold mb-2">Message</label>
                <textarea required rows={6} className="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:border-emerald-400 transition resize-none" placeholder="Tell us what's going on..." />
              </div>
              <button className="w-full sm:w-auto px-8 py-3 rounded-xl bg-emerald-500 text-white font-semibold hover:bg-emerald-400 transition shadow-md">
                Send message
              </button>
            </form>
          )}
        ...
        <aside className="lg:col-span-2 space-y-5">
          <div className="p-6 rounded-2xl border border-slate-200 bg-white">
            ...
            <a href="tel:+442035000000" className="block mt-1 text-2xl font-black text-slate-900 hover:text-emerald-600">+44 20 3500 0000</a>
            <div className="mt-2 text-sm text-slate-600">Avg pickup: 38 seconds · 24/7</div>
          </div>
          <div className="p-6 rounded-2xl border border-slate-200 bg-white">
            <div className="font-bold">General support</div>
            <a href="mailto:hello@shipenvoy.com" className="block mt-1 text-emerald-600 font-semibold">hello@shipenvoy.com</a>
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white">
            ...
            <a href="mailto:sales@shipenvoy.com" className="block mt-1 text-emerald-600 font-semibold">sales@shipenvoy.com</a>
            <div className="mt-1 text-sm text-slate-500">For volumes above 10k/month</div>
          </div>
          <div className="p-6 rounded-2xl border border-slate-200 bg-white">
            <div className="font-bold">Press</div>
            <a href="mailto:press@shipenvoy.com" className="block mt-1 text-emerald-600 font-semibold">press@shipenvoy.com</a>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div key={o.h} className="p-5 rounded-2xl bg-slate-50 border border-slate-100">
              ...
              <a href={`tel:${o.t}`} className="mt-1 block text-sm text-emerald-600 font-semibold">{o.t}</a>
            </div>
          ))}
        </div>
      </section>
